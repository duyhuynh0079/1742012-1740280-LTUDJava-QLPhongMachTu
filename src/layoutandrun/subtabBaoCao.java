...
public class subtabBaoCao extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					subtabBaoCao frame = new subtabBaoCao();
	...
	public subtabBaoCao() {
		...
		lblNewLabel_1.setBounds(45, 156, 225, 24);
		...
		lblNhpThng.setBounds(315, 417, 79, 24);
		jpn.add(lblNhpThng);
		...
		lblNhpThng_1.setBounds(315, 599, 79, 24);
		...
		btnBCDoanhThu.setIcon(new ImageIcon("C:\\Users\\Mr.F\\Documents\\GitHub\\1742012-1740280-LTUDJava-QLPhongMachTu\\Source\\images\\report2.png"));
		btnBCDoanhThu.setFont(new Font("Tahoma", Font.BOLD, 14));
		btnBCDoanhThu.setBounds(812, 212, 121, 67);
		jpn.add(btnBCDoanhThu);
		
		btnBCThuoc = new JButton("In");
		btnBCThuoc.setIcon(new ImageIcon("C:\\Users\\Mr.F\\Documents\\GitHub\\1742012-1740280-LTUDJava-QLPhongMachTu\\Source\\images\\report1.png"));
		btnBCThuoc.setFont(new Font("Tahoma", Font.BOLD, 14));
		btnBCThuoc.setBounds(812, 389, 121, 73);
		jpn.add(btnBCThuoc);
		
		btnBCLoaiBenh = new JButton("In");
		btnBCLoaiBenh.setIcon(new ImageIcon("C:\\Users\\Mr.F\\Documents\\GitHub\\1742012-1740280-LTUDJava-QLPhongMachTu\\Source\\images\\report3.png"));
		btnBCLoaiBenh.setFont(new Font("Tahoma", Font.BOLD, 14));
		btnBCLoaiBenh.setBounds(812, 577, 121, 67);
